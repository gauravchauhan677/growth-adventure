export const expeditionDetails = {
  ...
  price: '₹3,75,000',
  image: '/images/expeditions/shivling.jpg',
  itinerary: [
    {
      day: 1,
  ...
  gallery: [
    '/images/gallery/shivling-1.jpg',
    '/images/gallery/shivling-2.jpg',
    '/images/gallery/shivling-3.jpg',
    '/images/gallery/shivling-4.jpg'
  ]
},
    'audens-col-expedition': {
      ...
      price: '₹99,999',
      image: '/images/expeditions/audens-col.jpg',
      itinerary: [
        {
          day: 1,
          title: 'Arrival in Delhi',
      ...
      gallery: [
        '/images/gallery/audens-1.jpg',
        '/images/gallery/audens-2.jpg',
        '/images/gallery/audens-3.jpg',
        '/images/gallery/audens-4.jpg'
      ]
    },
    'kalindi-khal-expedition': {
      ...
      price: '₹1,49,999',
      image: '/images/expeditions/kalindi-khal.jpg',
      itinerary: [
        {
          day: 1,
          title: 'Arrival in Delhi',
      ...
      gallery: [
        '/images/gallery/kalindi-1.jpg',
        '/images/gallery/kalindi-2.jpg',
        '/images/gallery/kalindi-3.jpg',
        '/images/gallery/kalindi-4.jpg'
      ]
    },
    'meru-expedition': {
      id: 4,
